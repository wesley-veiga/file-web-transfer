...
- [ ] **T-805 · OOM ao verificar integridade no upload (hash de arquivo grande)** ⬅ T-801, T-802, T-804
...
- [ ] **T-807 · Servidor não sobrevive a operações longas em segundo plano (sem foreground service real) + listagem de pasta lenta** ⬅ T-203, T-405, T-801
